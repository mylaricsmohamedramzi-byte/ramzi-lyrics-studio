export const allSongs: any[] = [
  ...
  },
  {
    ...
    "lyrics": [
      ...
      { "text": " ", "red": false },
      { "text": "دا جمالك غير ترتيبي... خلى عيوني ليك يتشوقه", "red": false },
      { "text": " ", "red": false },
      { "text": "قرب تعالي لي يا حبيبي... واللي هتحلم بيه هحققه", "red": false },
      { "text": " ...............", "red": false },
      { "text": "ياما نفسي أشغل عقلك.. وأدخل قلبك", "red": false },
      { "text": "وأكتب أسمي عليه.. وإن كان في جرح أداويه", "red": false },
      { "text": "عشان أخليك عايش يا حبيبي... مبسوط زي البيه", "red": false },
      { "text": " ", "red": false },
      { "text": " ", "red": false },
      { "text": " ", "red": false },
      { "text": "أصل إنت آخر صبري.. يا حبيب عمري", "red": false },
      { "text": "جيت حليت لي الأيام.. عوضت لي قلبي غرام", "red": false },
      { "text": "والله أنا من يوم ما قابلتك... وأنا مهتم اهتمام", "red": false }
    ]
  },
  {
    "id": 22,
    ...
    "type": "سلو",
    "lyrics": [
      { "text": "وأنا وياك", "red": false },
      { "text": " بتبان الفرحة في عينيه.و  بترجع ضحكتي ليّه", "red": false },
      { "text": " وحالتي بتبقا طبيعية .. وببقا تمام", "red": false },
      { "text": "", "red": false },
      { "text": "وأنا وياك ", "red": false },
      { "text": " بلقي قلبي بيرفرف .. و روحك مني بتقرب", "red": false },
      { "text": "بيبقا لساني متكهرب ..مش  لاقي كلام", "red": false },
      { "text": "", "red": false },
      { "text": "وأنا وياك", "red": false },
      { "text": "بشوفك نجم ومنور .. و بيزيد الغرام أكثر", "red": false },
      { "text": "قلبي بيضعف و يتاثر.. وبميل أوام", "red": false },
      { "text": "", "red": false },
      { "text": " ...............", "red": false },
      { "text": "دا أنت اللي لمّا شافه قلبي ... سلّم إليه", "red": true },
      { "text": " ", "red": false },
      ...
      { "text": " ...............", "red": false },
      { "text": " ", "red": false },
      { "text": "يا أغلى الناس ", "red": false },
      { "text": "  معاك أنت الحياة تتعاش ..و من غيرك دي مبتسواش", "red": false },
      { "text": "أنا عنك مبستغناش ..دا أنا روحي فيك ", "red": false },
      { "text": " ", "red": false },
      { "text": "يا أغلى الناس ", "red": false },
      { "text": "يا قدري و أجمل هديه .. يا مالي دنياتي عليّا", "red": false },
      { "text": " يا ونَسي في كل لياليّه .. أنا كلي ليك", "red": false }
    ]
  },
  {
    "id": 23,
    ...
    "type": "رومانسي",
    "lyrics": [
      { "text": "مش مصدّق .. قلبي غرّق", "red": false },
      { "text": " قلبها .. في بحر عشقي", "red": false },
      { "text": " ", "red": false },
      { "text": "نفسي أشوف .. نظره حلوه", "red": false },
      { "text": "من عيونها .. وأنسي همّي", "red": false },
      { "text": " ", "red": false },
      { "text": "أيوه بسرح .. فيها وأسئل", "red": false },
      { "text": "هوا قلبها .. ليه هاجرني", "red": false },
      { "text": " ", "red": false },
      { "text": "دي الوحيده .. اللي ليها", "red": false },
      { "text": "قلت كل اللي في نفسي", "red": false },
      { "text": " ...............", "red": false },
      ...
      { "text": " ...............", "red": false },
      { "text": "قالو عنك  .. حاجه غاليه", "red": false },
      { "text": "قالو نار .. وقالو جنّه", "red": false },
      { "text": " ", "red": false },
      { "text": "قالو هادئة .. قالو راسيه", "red": false },
      { "text": "قالو أنّك حاجه تانيه", "red": false },
      { "text": " ", "red": false },
      { "text": "بس أول .. لمّا شفتك", "red": false },
      { "text": "اختفي ..كل الكلام دا", "red": false },
      { "text": " ", "red": false },
      { "text": "ومهما قالو..ومهما عادو", "red": false },
      { "text": "هتفضلي أنتي.. نور عنيه", "red": false }
    ]
  },
  {
    "id": 24,
    ...
    "lyrics": [
      ...
      { "text": " ", "red": false },
      { "text": " ...............", "red": false },
      { "text": " بس أنت مَلّيتها... ورجعتها تاني لطبيعتها", "red": true },
      { "text": " حببتني فيها.. وحلّيتها... كل الصعوبات بيك عديتها", "red": true },
      { "text": " أنا عديتها", "red": true },
      { "text": " ", "red": false },
      { "text": " ", "red": false },
      { "text": " ", "red": false },
      { "text": " أيوه أنت فارق لي... أيوه أنت وبس اللي تليق لي", "red": true },
      { "text": " يا اللي في أحلامي بتحقق لي... وإما بغيب عنك تشتاق لي", "red": true },
      { "text": " أنت فارق لي", "red": true },
      { "text": " ...............", "red": false },
      { "text": " ", "red": false },
      ...
      { "text": " دي حقيقه أنا مش بجاملها .. ناس كُتّر خيرها", "red": false },
