export const allVideos = [
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "طب ده أنا بطمن لمّا ", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "أّم أَنَّهُ كلاماً عابراً لا أسَاسَ لهُ من الوجودٍِ", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "أنا عندي طلاقه ف اللسان ايه.", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "_ هِيَ رُوحِي وَأَجْمَلُ أَقْدَارِي", red: true },
      { text: "\u00A0", red: false },
      { text: "_ وَنُكَوِّنُ نَسْلاً يَجْمَعُنَا", red: false },
      { text: "_ يَسْتَمْتِعُ بِالكَوْنِ مَعَنَا", red: false },
      { text: "_ لا نَتْرُكُ هَمّاً يَمْنَعُنَا", red: false },
      { text: "_ كَيْ نَجْعَلَ لِحَيَاتِنَا مَعْنَى", red: false },
      { text: "\u00A0", red: false },
      { text: "_ تِلْكَ الَّتِي شَغَلَتْ أَفْكَارِي", red: true },
      { text: "_ طِيلَةَ لَيْلِي وَنَهاري", red: true },
      { text: "_ بِجَمَالِهَا لَفَتَتْ أَنْظَارِي", red: true },
