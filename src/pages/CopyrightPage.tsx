    ...
    <div className="min-h-screen relative">
      ...
      <div className="container mx-auto px-4 max-w-5xl py-16 relative z-10">
        ...
        <div className="flex justify-center mb-8 animate-fade-in-up">
          ...
          >
            <div className="relative w-52 h-52 sm:w-64 sm:h-64 rounded-full overflow-hidden laser-border" style={{ zIndex: 2 }}>
              <img
                src={lang === 'ar' ? copyrightArabic : copyrightEnglish}
                alt={t('Copyright Owner - Mohamed Ramzi', 'حقوق ملكية - محمد رمزي')}
                className="w-full h-full object-contain relative bg-black/10"
                style={{
                  zIndex: 2,
                  filter: isDark
              ...
              />
              {/* Crisp laser border orbiting the circular stamp */}
