...
export const allSongs = [
  {
    ...
    lyrics: [
      { text: "نفسي لو بقا قلبي دايب ... تبقي انتي ليّه المدد", red: false },
      { text: "لو راحو مني الحبايب ... تفضلي انتي للئبد", red: false },
      { text: "نفسي لو مره أتكسرت ... تبقي انتي ليّه السند", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "أنا عاوز بس أسأل عينيه البريئة", red: false },
      ...
      { text: "\u00A0", red: false },
      { text: "دَا اللي كُل الصِّفَات الحُلْوَة فِيه", red: false },
      { text: "دَا حَتَّى الانْبِسَاط لائق عَلَيه", red: false },
      { text: "عَشَان كِدَه أَنَا اِعْجَبْت بِيه", red: false },
      { text: " وَنَاوِي أَعِيش عُمُرِي كُلُّه لِيه", red: false },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    credits: "كلمات وألحان : محمد رمزي",
    lyrics: [
      { text: "المطرب 👨‍💼", red: true },
      { text: "\u00A0", red: false },
      { text: "ربنا ما يحرمني منك", red: false },
      { text: " ربنا يخليكي ليّه", red: false },
      { text: "كل ما أطلب حاجة منك", red: false },
      { text: "بتقولي لي من عنيه", red: false },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "\u00A0", red: false },
      { text: "ربنا ما يحرمني منك", red: true },
      { text: "ربنا يخليك ليّه", red: false },
      { text: "كل ما أطلب حاجة منك", red: false },
      { text: "بتقولي من عنيّه", red: true },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼", red: true },
      { text: "\u00A0", red: false },
      { text: "وقت زهقي تفرقشيني", red: false },
      { text: "وقت زعلي تضحكين", red: false },
      { text: "أحلى وردة شافتها عيني.. ", red: false },
      { text: "إنتي يا أحسن هديه", red: false },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "\u00A0", red: false },
      { text: "أحلى حاجة شافتها عيني", red: false },
      { text: "أنت يا أحسن هديه", red: false },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼", red: true },
      { text: "\u00A0", red: false },
      { text: "إنتي قلبي روحي عيني إنت كل حاجة", red: true },
      { text: "نور عيوني كوني مصدر السعادة", red: true },
      { text: "غالية عندي عندي ليكي حب ياما", red: true },
      { text: " حب ياما", red: true },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "\u00A0", red: false },
      { text: "وأنت قلبي روحي عيني أنت كل حاجة", red: true },
      { text: "نور عيوني كوني مصدر السعادة", red: true },
      { text: "يا اللي حبك ساب فيه ميت علامة", red: true },
      { text: "ميت علامة", red: true },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼", red: false },
      { text: "\u00A0", red: false },
      { text: "أيوه كل الناس في كفه", red: false },
      { text: "وإنتي عندي في كفه ثانية", red: false },
      { text: "وقت وجعي بتبقي واقفه", red: false },
      { text: "مش بتبعدي عني ثانيه", red: false },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "\u00A0", red: false },
      { text: "يا جميل يا أبو قلب صافي", red: false },
      { text: "أنت يا سر إختلافي", red: false },
      { text: "إرتاحي يا روحي ليه تخافي", red: false },
      { text: "دا اللي هيحافظ عليه", red: false },
    ],
  },
  {
    id: 4,
    ...
    lyrics: [
      { text: "المطرب 👨‍💼", red: true },
      { text: "اه لو ننسى الغمّ شويه", red: false },
      { text: "والإِ حساس بالمسؤليه", red: false },
      { text: "لو دمعتي تفضل في عنيه ", red: false },
      { text: "و أسرح و أنسى معاك الدنيا", red: false },
      { text: "وأبقى في مود الروقان", red: false },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "و القيك يا حبيبي بتسمعني ", red: false },
      { text: "وتخفف لي ف هَمِّي و وجعي", red: false },
      { text: "تشغل بالي و تدخل قلبي", red: false },
      { text: "ميسبنيش ولا يبعد عني", red: false },
      { text: "تبقي السند والأمان", red: false },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼 مع المطربة 👩‍🎤", red: false },
      { text: "\u00A0", red: false },
      { text: "أنا مش عاوز حاجه من الدنيا", red: true },
      { text: " دا كفايه تكون جنبي", red: true },
      { text: "مش هقدر أضيع ولا ثانيه", red: true },
      { text: "يا حبيبي صدقن", red: true },
      { text: "دا مقامك عندي حاجة تانيه", red: true },
      { text: "اه يا حظّي وبختي", red: true },
      { text: "لِآخِر لحظه في عُمْرِي باقيه ", red: true },
      { text: "هتفضل في قلبي", red: true },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼", red: true },
      { text: "اه لو نفرح كام دقيقه", red: false },
      { text: "وتبان الضحكه البريئه", red: false },
      { text: "لو تبقى الأحلام حقيقه ", red: false },
      { text: "ونسيب الناس الخنيقه", red: false },
      { text: "و نحب و نعشق كمان", red: false },
      { text: "\u00A0", red: false },
      { text: "المطربة 👩‍🎤", red: true },
      { text: "وأعيش عُمْرِي معاك في سعاده", red: false },
      { text: "و يكبر حُبّنَا دا كل مَادّ", red: false },
      { text: "نعمل ما بدلنا و زياده", red: false },
      { text: "و ننجح كدا من غير إِعاده", red: false },
      { text: "ونتهّرب من الاحزان", red: false },
      { text: "\u00A0", red: false },
      { text: "المطرب 👨‍💼 مع المطربة 👩‍🎤", red: false },
      { text: "\u00A0", red: false },
      { text: "أنا مش عاوز حاجه من الدنيا", red: true },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "مع أن انا بفضل ألاغيه ", red: true },
      { text: "وهوا كمان بيلاغي فيا", red: true },
      { text: "لكن عِنده مسيطر عليه ", red: true },
      { text: "وبيقول اللي بينا صُحبيه", red: true },
      { text: "وأديني بسياره وبهاوده", red: true },
      { text: "وبفتح ف السيره كل شويه", red: true },
      { text: "ومسيره يقول اللي ف قلبه", red: true },
      { text: "و يقول بحبك ليّه", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "يا هل ترى حُبي لَكِي  مُتَبَادِلً", red: true },
      { text: "أّم أَنَّهُ كلاماً عابراً لا أسَاسَ لهُ من الوجودٍِ", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "كل دا كان كلام بيقوله ", red: false },
      { text: "و فاكرني هصدقه", red: false },
      { text: "كان جاي لغرض معرفش يطوله ", red: false },
      { text: "ف هرب قبل م أغرقه", red: false },
      { text: "و أهو لقي غيري و عماه بغروره", red: false },
      { text: "و خلّه يقع في ملعبه", red: false },
      { text: "\u00A0", red: false },
      { text: "الله يرحم أيام زمان ... لما كان", red: true },
      { text: "بيطير من الفرحه لو شافني", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    credits: "كلمات وألحان : محمد رمزي",
    lyrics: [
      { text: "متزعلش وحياتي عندك", red: false },
      { text: "مبقدرش أنا علي زعلك", red: false },
      { text: "اه غبت لكن هرجعلك", red: false },
      { text: "دا أنت غالي عندي", red: false },
      { text: "متقلقش طمن قلبك", red: false },
      { text: "مينفعش أبعد عنك", red: false },
      { text: "يا كل ما ليّه بحبك", red: false },
      { text: "ليه هداري يعني", red: false },
      { text: "\u00A0", red: false },
      ...
      { text: "\u00A0", red: false },
      { text: "حبيبي مهما غيبتي تطول", red: false },
      { text: "هفضل أحنلك علي طول", red: false },
      { text: "ومين عن هواه مسؤول", red: false },
      { text: "أعمل أيه في قلبي", red: false },
      { text: "\u00A0", red: false },
      { text: "شفت الحلو كله معاك", red: false },
      { text: "ضحكت لي الحياه وياك", red: false },
      { text: "فضلت سنين أستناك", red: false },
      { text: "يا حبيبي صدقني", red: false },
      { text: "\u00A0", red: false },
      { text: "وهخاف من أيه ... لا بجد هخاف من أيه", red: true },
      { text: "أيوه أنا حبيت ... والحب يا ناس مش عيب", red: true },
      { text: "دا ليه سحر جميل ... بيدخل قلبنا يحييه", red: true },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "إِنَّكِ وَطَنٌ جَمِيلْ .. صِرْتِ حُلْمَ الطَّامِعِينْ", red: false },
      { text: "\u00A0", red: false },
      ...
      { text: "\u00A0", red: false },
      { text: "بِقَوْلِنَا اللهُ أَكْبَر .. صِرْنَا نَحْنُ الفَائِزِينْ ", red: false },
  ...
  },
  {
    ...
    views: "0",
    lyrics: [
      { text: "وحشاني يا مصر وحشاني", red: false },
      { text: "وبقالي سنين عليكي غايب", red: false },
      { text: "بتمني أرجع ليكي تاني", red: false },
      { text: "علشان سايب فيكي حبايب", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني يا مصر واللهِ ", red: false },
      { text: "عايش في الغربه وحداني", red: false },
      { text: "والدنيا دي كلها تلاهي ", red: false },
      { text: "بس أنا فكرك و مش ساهي", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني الجيزه والقاهره", red: false },
      { text: " والحُسين و مقام السيده", red: false },
      { text: "وفُسحة النيل بالمركبه", red: false },
      { text: " الروح عليهم متعوده", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني يا مصر", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني القعده علي القهوه", red: true },
      { text: "أنا و أصحابي أحسن لمّهّ", red: true },
      { text: "نلعب شطرنج و طاوله", red: true },
      { text: "وصوت الست يحلّي السهره", red: true },
      { text: "والوقت يعدي و يسرقنا", red: true },
      { text: "ومفيش ولا  حاجه  تفرقنا", red: true },
      { text: "\u00A0", red: false },
      { text: "وحشاني يا مصر", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني سفريت سيناء", red: false },
      { text: "مع حبايبنا و أهالينا", red: false },
      { text: "وفانوس رمضان و الزينه", red: false },
      { text: "مع لعب الكوره في حوارينا", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني يا مصر", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني عزومة أختي وأخويا ", red: false },
      { text: "اللي موصيني عليها أبويا", red: false },
      { text: "قالي  أشيلهم في عنيه", red: false },
      { text: "ومزعلهمش ولا  ثانيه", red: false },
      { text: "أصل مليش غيرهم في الدنيا ", red: false },
      { text: " دا حياتي معاهم حاجه تانيه", red: false },
      { text: "\u00A0", red: false },
      { text: "وحشاني يا مصر", red: false },
      { text: "\u00A0", red: false },
      { text: "مُشتاق للناس المصريين", red: false },
      { text: "اللي بحالهم دائماً راضيين", red: false },
      { text: "أهل الكرم و الطيبين", red: false },
      { text: "وبالشهامه دول معروفين", red: false },
      { text: "والجدعان فيهم بالملايين", red: false },
      ...
      { text: "في صلتنا تملي بندعي لها ", red: false },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "بهجه وسعاده تسوي كل الدنيا", red: true },
      ...
      { text: "\u00A0", red: false },
      { text: "شهر بنستناه طول العام", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "قربت أطلع أنا من الهدوم", red: false },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "وعبدِ اللهِ والحسَنِ", red: false },
      ...
      { text: "\u00A0", red: false },
      { text: "صلُّوا على المُصطفى", red: true },
      { text: "رمزِ المحبَّةِ والوفا", red: true },
      { text: "خُلُقُهُ ربِّي مُشرَّفٌ", red: true },
      { text: "وبخُلُقِهِ الكونُ إحتفى.", red: true },
      { text: "\u00A0", red: false },
      ...
      { text: " يا قُرآنًا على الأرضِ  يا نبعَ التُّقَى", red: false },
      { text: "\u00A0", red: false },
      { text: "يا جَدَّ زينبَ وعليٍّ", red: false },
      { text: "وعبدِ اللهِ والحسَنِ", red: false },
      { text: "وأمِّ كُلثومَ وأُمامةَ", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "وهَبْ لي مِن لَدُنكَ ًمًّناً ", red: true },
      { text: "فقد أتيتُكَ تائبًا فاقبَلْ تَوبتي ورُجُوعي", red: true },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "\u00A0", red: false },
      { text: "اللَّهُمَّ إِنِّي أَحْمَدُكَ حَمْدًا كَثِيرًا", red: true },
      { text: "كَمَا يَنْبَغِي لِجَلَالِ وَجْهِكَ وَعَظِيمِ سُلْطَانِكَ", red: true },
      { text: "\u00A0", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "هما خطفو العين وانتي ", red: false },
      { text: "جوا عيني ساكنه", red: false },
      { text: "الجمال علامات وانتي", red: false },
      { text: "جمالك ماركة", red: false },
      { text: "هما بيجيبوا همّ وانتي", red: false },
      { text: "طلتك فيها بركه", red: false },
      { text: "\u00A0", red: false },
      ...
      { text: "\u00A0", red: false },
      { text: "يا أهل الهوا", red: true },
      { text: "زوْدو العُشاق أثنين", red: true },
      { text: "\u00A0", red: false },
      { text: "مهما اغيب عليكي برضه", red: false },
      { text: "عمري ما انساكي", red: false },
      { text: "دا الحياة بتضحك لي لمّا", red: false },
      { text: " ببقا وياكي", red: false },
      { text: "دا كفايه سؤالك عليّا", red: false },
  ...
  },
  {
    ...
    lyrics: [
      ...
      { text: "وَلأَنَّ بُعْدَكْ عَنِّي مُدَمِّرْ أَعْصَابِي ", red: false },
...
export default function SongsPage() {
  ...
  useEffect(() => {
    ...
    const onKey = (e: KeyboardEvent) => { if (e.key === 'Escape') setFullscreenSong(null); };
  ...
  return (
    <div dir="rtl" className="page-wrapper">
      ...
      <style>{`
        ...
        .line { font-family: 'DG Heaven', 'DG Heaven Bold', 'DG Modal3at', sans-serif !important; font-weight: 400; font-size: 1.45rem; color: #ffffff; line-height: 2.1; margin-bottom: 10px; border-right: 3px solid #c9a84c; padding-right: 15px; }
