    ...
    description: {
      ar: (
        <div className="method-text">
          ...
          <br />
          خلينا نقول أني أخترت أتكلم عن فكرة الأشخاص اللي بتظهر ف حياتنا من العدم وتقرب مننا في وقت قليل جداً وتدّعي أننا غالين عندها وكدا، وبمجرد ما توصل لحاجه معينه مننا بتختفي تاني و لا كأنها عرفانه
