    ...
    <div className="min-h-screen">
      ...
      <div className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center animate-fade-in-up">
          <Pen className="w-14 h-14 mx-auto mb-4 text-[#c9a84c] opacity-80" />
          <h1
          ...
          >
            {t('SONGWRITING ART', 'فن كتابة الأغاني')}
          </h1>
        ...
        <div className="max-w-md mx-auto">
          <div className="relative group">
            ...
            <input
              ...
              placeholder={t('Search methods...', 'ابحث عن الأساليب...')}
      ...
      <div className="container mx-auto px-4 max-w-5xl animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
        ...
        >
          ...
          <p className="text-xl font-body text-muted-foreground italic">
            {t('♪ No methods yet — check back soon', '♪ لا أساليب بعد — تابعنا قريباً')}
          </p>
        </div>
      </div>
    </div>
