    ...
    description: {
      ar: (
        <div className="method-text">
          ...
          songName: 'وهي عامله إيه',
          lyrics: [
            { text: '' }, { text: '' },
            { text: 'وهي عامله إيه دلوقت ... ومين هون عليها الوقت'  },
            { text: ' قولولي لو فى صالحها ... أروحلها و أصالحها' },
            { text: 'ظالمها وقلبي جارحها  ... أجيلها ولا مش دلوقت' }, 
          ],
          <br />
          <br />
          ...
          lyrics: [
            { text: '' }, { text: '' },
            { text: 'وهيّ بتاكل إيه دلوقت ... ومين اللي قاعد معاها عالاكل '  },
            { text: ' اخوها ولا صحبتها ... ولا لوحدها مفيش حدّ' },
            { text: 'يا تري الاكل عاجبها ...ولا أجيلها ومعايا أكل ' },
             ],
          <br />
          <span className="cyan" style={{ color: 'rgb(200, 50, 70)' }}>-- بيكون الكاتب مطلوب منه يكتب علي لحن أغنيه معينه عشان الأغنيه دي نجحت</span>
        </div>
